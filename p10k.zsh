# Generated by Powerlevel10k configuration wizard on 2022-06-06 at 14:06 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_SUBSEGMENT_SEPARATOR=' %244F⏐ '  # separate segments with a space
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      'ethos12prodva6/ns-team-launch-prod'  PROD
      'ethos12prodva6/*'  PRODLIKE
      'ethos12stageva6/*' TEST
      '*'       DEFAULT)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PRODLIKE_FOREGROUND='yellow'
  typeset -g POWERLEVEL9K_KUBECONTEXT_PRODLIKE_VISUAL_IDENTIFIER_EXPANSION='⚠️ '
